...
import ScrumImage from "@/components/Image";
    ...
    <main>
      <ProjectContainer>
        ...
        <p>
          ...
          trip. Particularly if it involves going to several shops or
          supermarkets to get all the needed grocery-items.
        </p>
        <p>
          The user can decide, in witch of the created stores he / she wants{" "}
          {"("}
          or can{")"} buy the products, that he / she created in the app. When
          the products are then put on the shopping list, the user can click on
          a product to see, where he / she needs to go, to get this product.
        </p>
